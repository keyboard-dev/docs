  ...
  return (
    <section className="relative pt-20 pb-14">
      ...
      <div className="mt-8 flex flex-wrap items-center gap-3">
        <a href="https://github.com/keyboard-dev/approver-client/releases/latest" className={pill}>
          Get the desktop app
        </a>
        ...
        <a
          href="https://github.com/keyboard-dev/keyboard-local"
  ...
  return (
    <section className="mt-24 rounded-3xl border border-fd-border px-6 py-10 text-center sm:p-10">
      ...
      <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        ...
        <Link href="/docs/getting-started/quickstart" className={pillGhost}>
          Read the quickstart
        </Link>
      </div>
    </section>
